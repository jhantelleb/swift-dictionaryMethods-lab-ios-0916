...
let starWarsHeroes = ["Luke Skywalker", "Princess Leia", "Han Solo", "Rey"]
 ...
 */
// write your code here
for (index, droid) in starWarsDroid.enumerate() {
    if droid == "IG-88"{
        starWarsDroid.removeAtIndex(index)}
}

/*: question6
 ### 6. Excellent! We want to store these arrays in a dictionary. Create a _variable_ dictionary called `starWarsCharacterss` with the following keys: "Heroes", "Villains", and "Droids". Assign the appropriate variables that you created in the previous questions to these keys when you initialize the dictionary.
 */
// write your code here
...
/*: question8
 ### 8. Insert `starWarsGangsters` into your `starWarsCharacterss` dictionary with the key "Gangsters". Use subscript notation.
 */
// write your code here
 ...
 */
// write your code here
if starWarsCharacters.isEmpty == true{
 ...
 */
// write your code here
let starWarsJedi = ["Yoda", "Obi-Wan Kenobi", "Mace Windu"]


/*: question13
 ### 13. Add the variable `starWarsJedi` to the `starWarsCharacters` dictionary using the key "Jedi". Use the `updateValue(_:forKey:)` method to do this. If a new key was added, print "Added Jedi key" to the console; otherwise, print "Updated Jedi key" to the console.
 */
// write your code here
let characterAdded = starWarsCharacters.updateValue(starWarsJedi, forKey: "Jedi")
...
/*: question14
 ### 14. I can't remember if we added the a key/value pair for "Bounty Hunters" or not. Regardless, let's not worry about them for now. Use the `removeValueForKey()` method to remove "Bounty Hunters" from `starWarsCharacterss`. Print the message "Removed Bounty Hunters" if the key was present in the dictionary, or "Bount Hunters did not exist" if it wasn't.
 */
// write your code here
let characterRemoved = starWarsCharacters.removeValueForKey("Bounty Hunters")
if characterRemoved == nil{
...
/*: question15
 ...
 After you've fixed the error, print out the contents of the "Jedi" key in `starWarsCharacterss` to make sure your code works.
 */
